                           ...
                           {relatedSlide.visuals && relatedSlide.visuals.length > 0 && (
                             <div>
                               <div className="flex items-center justify-between mb-2">
                                  ...
                                  >
                                    <span>Generated Images ({result.visual_id ? 1 : relatedSlide.visuals.length})</span>
                               ...
                               {expandedResults.has(result.id) ? (
                                 <div className="grid grid-cols-3 gap-2">
                                    {/* Show only the visual generated by this specific test */}
                                    {(() => {
                                      const testVisual = result.visual_id ? 
                                        relatedSlide.visuals.find(v => v.id === result.visual_id) : 
                                        relatedSlide.visuals[0]; // Fallback for older tests without visual_id
                                      return testVisual ? [testVisual] : [];
                                    })().map((visual) => (
