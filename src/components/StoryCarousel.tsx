...
export default function StoryCarousel({ story, storyUrl, topicId, storyIndex = 0, isRoundupView = false, onStorySwipe, onStoryScrolledPast, topicName, topicSlug }: StoryCarouselProps) {
  ...
  const handleShare = async () => {
    ...
    // Use Supabase edge function for share URLs
    const shareUrl = `https://fpoywkjgdapgjtdeooak.supabase.co/functions/v1/share-page?type=story&id=${story.id}&topic=${topicId || currentSlug}`;
