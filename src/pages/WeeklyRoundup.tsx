  ...
  useEffect(() => {
    const loadWeeklyRoundup = async () => {
      ...
      try {
        ...
        console.error('Error loading weekly roundup:', error);
        toast({
          title: "Error loading roundup",
          description: "Failed to load the weekly roundup. Please try again.",
          variant: "destructive",
        });
        setRoundup(null);
      } finally {
        ...
        <div className="container mx-auto px-1 md:px-4 py-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              The weekly roundup starting {weekStart ? format(parseISO(weekStart), 'MMMM d, yyyy') : 'this date'} is not available yet.
            </p>
            <Button asChild>
              <Link to={`/feed/${slug || ''}`}>
