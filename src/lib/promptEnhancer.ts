...
export const enhancePromptWithSettings = (
  ...
  const toneInstructions = {
    ...
    rhyming_couplet: "Write EVERY slide as a rhyming couplet—two lines that rhyme at the end. Channel the heroic couplets of Alexander Pope and John Dryden, Shakespeare's closing couplets, the wit of Hilaire Belloc and Ogden Nash. Use iambic pentameter where natural. Each couplet must be clever, memorable, and deliver genuine news. The humor comes from cramming serious news into elegant verse while maintaining factual accuracy."
  };
