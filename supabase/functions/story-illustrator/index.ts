...
STYLE & COMPOSITION:
Masterful hand-drawn editorial cartoon illustration - confident, clean pen-and-ink linework with editorial cartoon economy. Bold outline-driven style prioritizing clear contours and shapes over rendering detail. Think ligne claire sophistication meets contemporary editorial cartooning - Steve Brodner's confident outline work, Edel Rodriguez's bold graphic clarity, NOT Jack Davis's heavy crosshatching. Expressive line variation in **weight** (thick vs thin outlines), but minimal hatching/shading. Clean black ink (#000000) on pure white (#FFFFFF) background. Strategic use of solid blacks and negative space for dramatic impact - shadows rendered as solid black shapes, not crosshatched gradations. Strong compositional structure with clear visual hierarchy achieved through outline confidence, not rendering detail. The drawing should feel created by a master cartoonist's hand, not generated by vector software. Spatial relationships: Maintain clear physical boundaries between figures and environment. If a character's lower body is visible, ensure proper grounding with natural contact points.

RENDERING RESTRAINT:
- EMPHASIS: Bold, confident **outlines** define forms
- MINIMAL: Hatching, crosshatching, stippling, texture work
- Shading technique: Use solid black fills for shadows, not graduated hatching
- Detail level: Include only essential visual information - avoid decorative rendering
- Think: "How would this look as a bold newspaper editorial cartoon?" not "How would an illustrator render this with pen technique?"
- Reference: Ligne claire clarity (Hergé), modern editorial cartoon simplicity (Edel Rodriguez bold graphics)
...
Line work: Bold, clean outlines with confident pen control - vary line **weight** (thick/thin) for emphasis and hierarchy, but avoid decorative hatching or texture. Economy of line: every stroke serves the story, nothing extraneous. Think editorial cartoon directness, not illustration rendering. The pen work should feel human and masterful, not algorithmic.
