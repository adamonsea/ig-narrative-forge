...
STYLE & COMPOSITION:
Masterful hand-drawn editorial cartoon illustration - confident pen-and-ink craftsmanship in the tradition of Rube Goldberg, Jack Davis, Steve Brodner, and Edel Rodriguez. Expressive, skilled linework with deliberate variation in weight and texture. Contemporary editorial cartoon sophistication - intelligent visual storytelling with artistic personality and authority. Clean black ink (#000000) on pure white (#FFFFFF) background. Strategic use of solid blacks, confident hatching, and negative space for dramatic impact. Strong compositional structure with clear visual hierarchy. The drawing should feel created by a master cartoonist's hand, not generated by vector software. Spatial relationships: Maintain clear physical boundaries between figures and environment. If a character's lower body is visible, ensure proper grounding with natural contact points.
...
Line work: Drawn with skilled confidence by a master editorial cartoonist - lines that feel certain, expressive, and deliberately varied. Hand-drawn craftsmanship with contemporary visual journalism sensibility. Fresh and current, with editorial weight, artistic personality, and authority. The pen work should feel human and masterful, not algorithmic.
