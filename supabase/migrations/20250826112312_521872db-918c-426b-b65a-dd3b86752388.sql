...
-- First, drop ALL existing policies more carefully
...
DROP POLICY IF EXISTS "Posts viewable by region access" ON public.posts;
...
DROP POLICY IF EXISTS "Content generation queue viewable by region access" ON public.content_generation_queue;
