...
-- Comment these out if you do NOT want public reads.
...
-- Authenticated writes (role restriction handled by TO)
...
DROP POLICY IF EXISTS "Stories write by authenticated" ON public.stories;
CREATE POLICY "Stories write by authenticated"
...
DROP POLICY IF EXISTS "Posts write by authenticated" ON public.posts;
CREATE POLICY "Posts write by authenticated"
