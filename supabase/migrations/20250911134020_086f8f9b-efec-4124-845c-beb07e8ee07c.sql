...
DROP FUNCTION IF EXISTS get_topic_articles_multi_tenant(uuid, text, integer, integer);
DROP FUNCTION IF EXISTS get_topic_articles_multi_tenant(uuid, integer, integer);

-- Create new function to get topic articles for multi-tenant structure
