-- Fix get_public_topic_feed function with correct column references
...
BEGIN
  ...
  GROUP BY s.id, s.article_id, s.title, sac.title, a.title, a.summary, sac.body, 
           s.author, sac.author, a.author, s.status, s.is_published, 
