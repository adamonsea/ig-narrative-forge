-- Drop all versions of get_topic_stories_with_keywords
...
-- Recreate the correct version with all required fields including parliamentary data
...
BEGIN
  ...
  WHERE ta.topic_id = v_topic_id
    ...
    AND (p_sources IS NULL OR ta.source_id = ANY(p_sources))
