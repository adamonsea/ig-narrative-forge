-- Drop and recreate the get_public_topic_feed function with correct joins
...
BEGIN
  ...
  RETURN QUERY EXECUTE format('
    ...
    GROUP BY s.id, sac.title, a.title, s.summary, sac.author, a.author, s.created_at, s.updated_at
