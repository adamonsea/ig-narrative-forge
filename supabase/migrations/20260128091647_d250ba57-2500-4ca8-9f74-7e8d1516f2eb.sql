-- Add animation_suggestions to get_admin_topic_stories function
DROP FUNCTION IF EXISTS get_admin_topic_stories(uuid, text, integer, integer);

CREATE OR REPLACE FUNCTION get_admin_topic_stories(
  p_topic_id uuid,
