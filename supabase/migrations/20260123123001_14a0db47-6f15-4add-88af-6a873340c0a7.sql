-- Restore get_user_dashboard_stats signature expected by TopicManager, but compute visitor stats from site_visits
...
BEGIN
  ...
  -- Visitor stats (NOW from site_visits)
  visitor_stats AS (
    SELECT 
      sv.topic_id,
  ...
  -- Email subscriber stats (from topic_newsletter_signups)
  subscriber_stats AS (
    SELECT 
      tns.topic_id,
