-- Drop the incorrect function and recreate with correct parameters matching the frontend code
DROP FUNCTION IF EXISTS public.get_topic_stories_with_keywords(uuid, integer, integer, text[], uuid[]);
