-- Fix parliamentary vote and article date sorting in feeds
-- Change ORDER BY to use actual published dates instead of story creation dates
...
BEGIN
  ...
  -- CRITICAL FIX: Order by actual published/vote date, falling back to story creation date
